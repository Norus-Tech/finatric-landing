                		...
                		<div className="container">
                			<div className={classNames('grid', {'justify-md-center': has_logo === false})}>
                				...
                				<Link className="site-footer__logo cell-12 cell-md-5 my-4" to={withPrefix('/')}>
                					<img style="height:50%; width: 100%" src={withPrefix(_.get(this.props, 'pageContext.site.siteMetadata.footer.logo', null))} alt={_.get(this.props, 'pageContext.site.siteMetadata.header.logo_alt', null)} />
                				</Link>
                				)}
